...
- **Community at scale** — Founded and grew [DevOps'ish][1] to 5,000+ subscribers; co-founded EKS.news while at AWS; curated KubeWeekly during my time as a CNCF Ambassador; onboarded multiple Kubernetes Contributors into the project
...
- **Proven ROI** — Infrastructure optimization that has saved organizations millions; saved crucial government programs from being scrapped; and ensured license compliance with hundreds of dependencies across multiple projects. Successful project and product launches include Valkey (now the leading Redis alternative), EKS.news, OpenShift.TV (now Red Hat Live Streaming), and the [DevOps'ish][1] newsletter.
...
[1]: https://buttondown.com/devopsish